...
import no.uib.storbioinfogui.util.BareBonesBrowserLaunch;
...
public class HelpDialog extends javax.swing.JDialog {
    ...
    public HelpDialog(Frame parent, URL fileName, String reference) {
        ...
        try {
            ...
            if (fileName.getPath().endsWith("AboutStoreBioinfoGUI.html")) {
                setTitle("About");
                //setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/icons/store-bioinfo.gif")));
            } else {
